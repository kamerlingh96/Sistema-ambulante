...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row formulario">
			<div class="col-12">
				<form action="<?= base_url() ?>login" method="post" name="edicionCorrecta" class="form-center">
					<div class="label-input">
						...
						<div class="row">
							<div class="col-12 input">
								<input type="password" name="pass" value="" required class="input100" placeholder="Contraseña">
							</div>
						</div>
						<br>
					</div>
					<div class="btn-form-center">
						<input type="submit" name="" value="Ingresar al sistema">
					</div>
				</form>
				<br>
				<div class="recuperar">
					<a href="<?= base_url()?>Recuperar_controller"><p><span>Recuperar contraseña</span></p></a>
				</div>
				<br>
				<br>
				<br>
		...
		<div class="row footer">
			...
			<div class="col-md-12 text-footer">
				<h4>H. AYUNTAMIENTO DE CARMEN - COORDINACIÓN DE GOBERNACIÓN MUNICIPAL</h4>
			</div>
		</div>
	</div>
