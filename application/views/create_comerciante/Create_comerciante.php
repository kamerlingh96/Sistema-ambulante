                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body wizard-content">
                                ...
                                <form action="<?= base_url() ?>Create_comerciante_controller/Create_comerciante" class="validation-wizard wizard-circle " method="post" name="formulario1" enctype="multipart/form-data" id="create_comerciante">
                                    <!-- Step 1 -->
